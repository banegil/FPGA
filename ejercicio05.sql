...
FROM DEPARTMENT LEFT JOIN EMPLOYEE ON DEPTNO = WORKDEPT
ORDER BY DEPTNAME, LASTNAME;

SELECT DEPTNAME, EMPNO, LASTNAME
FROM EMPLOYEE RIGHT JOIN DEPARTMENT ON WORKDEPT = DEPTNO
ORDER BY DEPTNAME, LASTNAME;

SELECT DEPTNAME, EMPNO, LASTNAME
FROM DEPARTMENT FULL JOIN EMPLOYEE ON DEPTNO = WORKDEPT
ORDER BY DEPTNAME, LASTNAME;
...
FROM DEPARTMENT LEFT JOIN EMPLOYEE ON DEPTNO = WORKDEPT
WHERE LASTNAME IS NULL
ORDER BY DEPTNO, DEPTNAME, LASTNAME;
